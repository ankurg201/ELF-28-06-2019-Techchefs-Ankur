							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-12 form-group">
										<label>Emp ID</label> <input class="form-control" type="empId"
											name="empId" placeholder="Enter Employee ID" />
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<input type="checkbox" id="cbpassword"><span
											style="font-size: 12px;">Show Password</span>
									</div>
								</div>
								<span class="text-danger small" id="password-error"
								...
								<span class="text-danger small" id="cfpassword-error"
									style="display: none"></span> <br>
								<div class="row">
									<div class="col-md-12 form-group">
										<button class="form-control btn btn-outline-info "
											type="submit" id="myButton">Submit</button>
									</div>
								</div>
